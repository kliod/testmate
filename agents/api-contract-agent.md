...
✅ **Always do:**
- Read `docs/mocking-strategy.md` to understand the project's declared mocking approach before rejecting a mock.
...
## Discovery Mandate
Before checking mocks, identify the mocking strategy used in this project: MSW, Nock, manual `jest.mock()`, or custom fixtures. Check `docs/mocking-strategy.md` and `package.json`.
